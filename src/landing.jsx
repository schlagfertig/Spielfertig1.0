...
function bandCardLogoStyle(name) {
  const hardys = /hardy/i.test(name || "");
...
export { Landing, AddBandModal, BAND_COLORS, BAND_EMOJIS, downloadJSON, buildBandExport, todayStamp };
