...
const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhzdHdobXF3eG12bG9idnlnc3R5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk2MDE3NjAsImV4cCI6MjA5NTE3Nzc2MH0.DZK81qIrUo3gLldLO344T_wY_Al1MSzg3oCASPkaVqo";
...
function AuthScreen({ onAuth }) {
  ...
  const handle = async () => {
    ...
    try {
      ...
      if (res.error || res.error_description) { setError(res.error_description || res.error?.message || JSON.stringify(res)); }
